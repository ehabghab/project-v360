...
def main():
    ...
    for tileWidth,tileHeight in zip((widths),(heights)):
		for bandwidth in bandwidths:
			...
			print len(networkDelayAll[tileResKey][bandwidth])
    ...
    plt.ylim(0,150)
    #plt.show()
    plt.savefig("graphs/vID "+str(video)+"_chunk length "+str(chunkLength)+"_ms_network_delay_bandwidth_boxplot.png",dpi=300)
	#plt.close()
