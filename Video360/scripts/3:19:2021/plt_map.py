...
def plotMap(tileMap,cx,cy,tileWidth,tileHeight,fname):
	...
	plt.scatter(cx,cy,linewidth='2',marker='x',color='r')
	offset = FOV/2.0
	...
	plt.savefig("graphs/frame_"+str(fname)+".eps",dpi=300,bbox_inches='tight',pad_inches=.05)
	plt.close()
