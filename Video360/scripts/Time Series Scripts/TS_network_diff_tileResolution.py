...
def main():
	...
	plt.scatter(chunkIdList,networkList,linewidth=2,marker='v',color='b',label = str(360/tileWidth)+"x"+str(180/tileHeight))
	#====================================================================================================
    #the number of switches.
	#the transmission delay of switch, and decode latency.
    tileWidth = 30
	...
	plt.scatter(chunkIdList,networkList,linewidth=2,marker='x',color='r',label = str(360/tileWidth)+"x"+str(180/tileHeight))
	...
	plt.scatter(chunkIdList,networkList,linewidth=2,marker='o',color='g',label = str(360/tileWidth)+"x"+str(180/tileHeight))
	...
	plt.ylim(0)
	#plt.show()
	plt.savefig("graphs/vID "+str(video)+" uID "+str(uID)+"_chunk length "+str(chunkLength)+"_ms_network.png",dpi=300)
	#plt.close()
