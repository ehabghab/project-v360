...
def main():
	...
	plt.plot(sorted_data,yvals,linewidth=3,color='b',label=str(tileWidth)+"X"+str(tileHeight))
	#######################################################################################################
	...
	sorted_data = np.sort(ywastage)
	yvals=np.arange(len(sorted_data))/float(len(sorted_data)-1)
	plt.plot(sorted_data,yvals,linewidth=3,color='r',label=str(tileWidth)+"X"+str(tileHeight))
	...
	sorted_data = np.sort(ywastage)
	yvals=np.arange(len(sorted_data))/float(len(sorted_data)-1)
	plt.plot(sorted_data,yvals,linewidth=3,color='g',label=str(tileWidth)+"X"+str(tileHeight))

	plt.title("vID:"+str(video)+", chunk length "+str(chunkLength) +"ms")
	...
	#plt.show()
	plt.savefig("graphs/vID:"+str(video)+", chunk length "+str(chunkLength) +"ms_CDF_all_multiReso.png",dpi=300)
