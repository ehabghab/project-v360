...
def main():
	...
	for uID in wasteOver1Sec:
		...
		plt.subplot(111)
		plt.scatter(xaxis,ywastage,linewidth=2,marker='v',color='b',label = str(chunkLength)+"ms")
	...
	for uID in wasteOver1Sec:
		...
		plt.scatter(xaxis,ywastage,linewidth=2,marker='x',color='red',label = str(chunkLength)+"ms")


	#############################################################################################
    chunkLength = 250 #chunk length in millisecond
	...
	for uID in wasteOver1Sec:
		...
		plt.scatter(xaxis,ywastage,linewidth=2,marker='o',color='g',label = str(chunkLength)+"ms")


	#############################################################################################

		xticks = list()
		for i in range (0,chunkID + 4,2):
			xticks.append(i)
		...
		plt.ylim(0,250)#,300)#,100)#,1)
		plt.xlim(-1,chunkID + 1)
		#plt.show()
		plt.savefig("graphs/vID "+str(video)+" uID "+str(uID)+"_tileRes W:"+str(tileWidth)+",H:"+str(tileHeight)+"_multi_tileLength.png",dpi=300)
		#plt.close()
