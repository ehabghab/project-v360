...
def main():
	...
	for uID in wasteOver1Sec:
		...
		plt.subplot(111)
		#plt.scatter(xaxis,ywastage,linewidth=4,marker='o',color='r',label = str(tileWidth)+"X"+str(tileHeight))
	...
	for uID in wasteOver1Sec:
		...
		plt.scatter(xaxis,ywastage,linewidth=2,marker='v',color='b',label = str(tileWidth)+"X"+str(tileHeight))
	...
	for uID in wasteOver1Sec:
		...
		plt.scatter(xaxis,ywastage,linewidth=2,marker='x',color='red',label = str(tileWidth)+"X"+str(tileHeight))
	...
	for uID in wasteOver1Sec:
		...
		plt.scatter(xaxis,ywastage,linewidth=2,marker='o',color='g',label = str(tileWidth)+"X"+str(tileHeight))
	...
	#############################################################################################
		...
		#plt.show()
		plt.savefig("graphs/vID "+str(video)+" uID "+str(uID)+"_chunk length "+str(chunkLength)+"_multi_tileResol.png",dpi=300)
		#plt.close()
