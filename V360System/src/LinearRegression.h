// This is adapted from: https://www.analyticsvidhya.com/blog/2020/04/machine-learning-using-c-linear-logistic-regression/
...
public:
	...
	vector<float>yawError; // for storing the yaw error values
	...
	vector<float>pitchError; // for storing the pitch error values
